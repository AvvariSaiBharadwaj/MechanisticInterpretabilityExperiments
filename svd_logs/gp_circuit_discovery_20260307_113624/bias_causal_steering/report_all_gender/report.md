...
- **Results JSON**: `../bias_causal_steering_sweep_all_gender.json`
...
- **Most masculinizing condition**: none of the tested conditions produced positive mean `delta_bias`; the closest condition was `sweep:1.0` with mean `delta_bias = -0.935`

...
- **Results JSON**: `../bias_causal_steering_sweep_feminine.json`
- **Prompt source**: `occupation_bias_prompts.json`
- **Mode**: `sweep`
- **Direction group**: `feminine`
- **Number of prompts**: `36`

## High-level findings

- **Most feminizing condition**: `sweep:1.0` with mean `delta_bias = -1.691`
- **Most masculinizing condition**: `sweep:-1.0` with mean `delta_bias = 0.083`
...
| --- | ---: | ---: | ---: | ---: |
| sweep:-1.0 | 0.532 | 0.614 | 0.083 | 19.44 |
| sweep:0.0 | 0.532 | -0.273 | -0.805 | 33.33 |
| sweep:1.0 | 0.532 | -1.159 | -1.691 | 61.11 |

...
- **Additional causal group inputs available**: `all_gender, feminine, masculine`
...
- **Closest causal match for masculine-only comparison**: the best available `masculine` causal run reaches accuracy `46.00%` at sweep `-0.845` with target logit diff `0.738`.
- **Closest causal match for feminine-only comparison**: the best available `feminine` causal run reaches accuracy `58.97%` at sweep `-0.220` with target logit diff `2.354`.
...
| he swap masculine only | he | masculine | 45.33 | 46.00 | 0.770 | 0.738 | 7.222 | 7.169 |
| she swap feminine only | she | feminine | 57.05 | 58.97 | 2.232 | 2.354 | 7.423 | 7.425 |
